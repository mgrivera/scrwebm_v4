...
import ConsultaMontosPagadosLista_Table from './ConsultaMontosPagadosLista_Table';
...
function MontosPagadosLista({ recordCount }) {
    ...
    const tempCollectionLoading = useTracker(() => {
        ...
        const handle = Meteor.subscribe('consulta.montosPagados.tempCollection.paging', page, recsPerPage, recordCount);
    ...
    const tempItems = useTracker(() => {
        // Note that this subscription will get cleaned up when your component is unmounted or deps change.
        const tempItems = Temp_consulta_montosPagados2.find({ user: Meteor.userId() }, {
    ...
    return (
        <div className="ui-viewBorder-left-aligned">
            ...
            <ToolBar title="Montos pagados / Consulta / Lista"
                url="consultas/montosPagados/filtro"
            ...
            <div className="ui-viewBorder"
                ...
                <ConsultaMontosPagadosLista_Table data={tempItems} />
            </div>
...
MontosPagadosLista.propTypes = {
    recordCount: PropTypes.number.isRequired,
};

export default MontosPagadosLista; 