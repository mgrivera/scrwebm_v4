...
Meteor.methods(
{
    tiposFacultativoSave: function (tiposFacultativo) {
        ...
        const inserts = lodash.chain(tiposFacultativo).
        ...
        const updates = lodash.chain(tiposFacultativo).
        ...
        const removes = lodash.filter(tiposFacultativo, function (item) { return item.docState && item.docState == 3; });
