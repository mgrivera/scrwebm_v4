...
let transaccion_PagoPrimas = function transaccion_PagoPrimas(remesa, cuota, riesgo, numeroTransaccion) {
    ...
    let transaccion = {
        ...
        transaccion: {
            ...
            descripcion: `Pago de primas (fac) - Riesgo y movimiento: (${cuota.source.origen}) ${cuota.source.numero} - cuota: ${cuota.numero.toString()} de ${cuota.cantidad.toString()}`,
        },
        partidas: []
    };
    ...
    partida.tipo = 400;      // 400: prima pagada (fac)
...
RemesasCuadre_Methods.transaccion_PagoPrimas = transaccion_PagoPrimas;
