...
Meteor.methods(
{
    'cierreRegistro.save': function (registro) {
        ...
        const inserts = lodash.chain(registro).
        ...
        const updates = lodash.chain(registro).
        ...
        const removes = lodash.filter(registro, function (item) { return item.docState && item.docState == 3; });
