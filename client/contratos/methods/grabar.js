...
let grabar = ($state, $scope, $modal, $meteor, uiGridConstants) => {
    ...
    validarArrayContraSchema($scope.contratosProp_cuentas_resumen, ContratosProp_cuentas_resumen, errores); 
    ...
    validarArrayContraSchema($scope.contratosProp_comAdic_resumen, ContratosProp_comAdic_resumen, errores); 
    ...
    validarArrayContraSchema($scope.contratosProp_partBeneficios_resumen, ContratosProp_partBeneficios_resumen, errores); 
    ...
    validarArrayContraSchema($scope.contratosProp_entCartPr_resumen, ContratosProp_entCartPr_resumen, errores); 
    ...
    validarArrayContraSchema($scope.contratosProp_entCartSn_resumen, ContratosProp_entCartSn_resumen, errores); 
    ...
    validarArrayContraSchema($scope.contratosProp_retCartPr_resumen, ContratosProp_retCartPr_resumen, errores); 
    ...
    validarArrayContraSchema($scope.contratosProp_retCartSn_resumen, ContratosProp_retCartSn_resumen, errores); 
    ...
    Meteor.call('contratosSave', $scope.contrato, $scope.cuotas.filter((x) => { return x.docState; }), 
