...
Meteor.methods(
{
    coberturasSave: function (coberturas) {
        ...
        var inserts = lodash.chain(coberturas).
        ...
        var updates = lodash.chain(coberturas).
        ...
        var removes = lodash.filter(coberturas, function (item) { return item.docState && item.docState == 3; });
