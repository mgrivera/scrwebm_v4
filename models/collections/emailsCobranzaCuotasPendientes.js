...
EmailsCobranzaCuotasPendientes = new Mongo.Collection("emailsCobranzaCuotasPendientes");
...
let atencionValidator = function() {
...
let usuariosValidator = function() {
    if (!_.isArray(this.value)) {
        return false;
    };

    let count = _.filter(this.value, (x) => { return x.tipo === 'From'; });
