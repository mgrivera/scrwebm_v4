...
angular.module("scrwebm")
       .controller("CuentasContablesAsociadas_Controller", ['$scope', 
function ($scope) {
    ...
    // ---------------------------------------------------------
    // subscriptions ...
    const cuentasContablesAsociadas_subscriptionHandle =
    ...
    function ui_grid_filterBy_tipoCuentaContable(searchTerm, cellValue) {
        ...
        const tipoCuentaContable = $scope.tiposCuentaContable.find(x => x.tipo === cellValue);
        ...
        const matches = tipoCuentaContable.descripcion.match(regexp);
    ...
    function ui_grid_filterBy_moneda(searchTerm, cellValue) {
        ...
        const moneda = $scope.monedas.find(x => x._id === cellValue);
        ...
        const regexp = RegExp(searchTerm, 'gi');
        const matches = moneda.simbolo.match(regexp);
    ...
    function ui_grid_filterBy_origen(searchTerm, cellValue) {
        ...
        const origen = $scope.origenes.find(x => x.origen === cellValue);
        ...
        const regexp = RegExp(searchTerm, 'gi');
        const matches = origen.descripcion.match(regexp);
    ...
    function ui_grid_filterBy_cuentaContable(searchTerm, cellValue) {
        ...
        const cuentaContable = $scope.cuentasContablesLista.find(x => x.cuenta === cellValue);
        ...
        const regexp = RegExp(searchTerm, 'gi');
        const matches = cuentaContable.descripcion.match(regexp);
    ...
    $scope.$on('$destroy', function () {
        cuentasContablesAsociadas_subscriptionHandle.stop();
    })
}])