...
export default angular.module("scrwebm.remesas.remesa", 
  ...
  function ($scope, $state, $stateParams, $uibModal, uiGridGroupingConstants) {
    ...
    $scope.tiposCuentaContable = [ 
        ...
        { tipo: 250, descripcion: "corretaje por pagar - fac", abreviatura: "pr x pag fac", }, 
        { tipo: 300, descripcion: "ingresos - fac", abreviatura: "corr fac", }, 
        ...
        { tipo: 1100, descripcion: "ingresos - cont", abreviatura: "corr cont", }, 
