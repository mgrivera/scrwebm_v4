...
['$scope', '$modalInstance', '$modal', '$meteor', 'uiGridConstants', 'codigoContrato', 'tablaConfiguracion', 'ciaSeleccionada',
function ($scope, $modalInstance, $modal, $meteor, uiGridConstants, codigoContrato, tablaConfiguracion, ciaSeleccionada) {
        ...
        onRegisterApi: function (gridApi) {
            ...
            gridApi.selection.on.rowSelectionChanged($scope, function (row) {
                ...
                if (row.isSelected) { 
                    ...
                    let itemSeleccionado = `${compania2} - ${itemSeleccionado.ano.toString()} - ${moneda.simbolo} - ${ramo.abreviatura} - ${tipo.abreviatura}`;
    ...
    $scope.parametrosConfiguracionForm_submit = () => {
        ...
        if ($scope.parametrosConfiguracionForm.$valid) {
            ...
            let companiaNosotros = lodash.some(companiasArray, (x) => { return x.nosotros; });
            if (!companiaNosotros) {
                DialogModal($modal, "<em>Contratos - Configuración</em>",
