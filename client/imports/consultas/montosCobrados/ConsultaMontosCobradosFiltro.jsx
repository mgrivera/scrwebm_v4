...
function ConsultaMontosCobradosFiltro() {
    ...
    useEffect(() => {
        ...
        const filtroAnterior = Filtros.findOne(
            {
                nombre: 'consultas.montosCobrados',
            ...
            (
                <div className="ui-viewBorder-left-aligned">
                    ...
                    <div>
                        ...
                        <a href={`consultas/montosCobrados/lista`}
                            ref={linkRef}
                            hidden>
                            go to list page ...
                        </a>
                    ...
                    <ToolBar title="Consultas / Montos cobrados / Filtro" />
...
function aplicarFiltro(e, formValues, setAlert, setShowSpinner, linkRef, companiaSeleccionada, subscriptionMonedas, subscriptionCompanias) {
    ...
    Meteor.call("consulta.montosCobrados", filtro, (error, result) => {
        if (error) {
...
function guardarFiltro(values) {
    ...
    const filtro = Filtros.findOne({ nombre: 'consultas.montosCobrados', userId: Meteor.userId() }, { fields: { _id: 1 } });
    if (filtro) {
...
export default ConsultaMontosCobradosFiltro; 