...
Meteor.methods(
{
    suscriptoresSave: function (suscriptores) {
        ...
        var inserts = lodash.chain(suscriptores).
        ...
        var updates = lodash.chain(suscriptores).
        ...
        var removes = lodash.filter(suscriptores, function (item) { return item.docState && item.docState == 3; });
